...
<div class='containter'>
  <div class='head_nav'><a href='index.py?id=${subject.subjectId}'>学科首页</a> &gt; <a href='${SubjectRootUrl}specialsubject/?specialSubjectId=${specialSubject.specialSubjectId}'>${specialSubject.title?html}</a> &gt; 专题图片</div> 			
<div>
<#if photo_list??>
<div style='clear:both;height:10px;'></div>
<div class='panel'>
   <div class='panel_head'>
    <div class='panel_head_left' style='width:300px'>&nbsp;<img src='${ContextPath}css/index/j.gif' />&nbsp;<a href='${SiteUrl}subject/specialsubject.py?id=${subject.subjectId}&specialSubjectId=${specialSubject.specialSubjectId}'>${specialSubject.title?html}</a> 的所有专题图片</div>
  </div>
 ...
 <#if photo_list.size() &gt; 0 >
    ...
    <#list 0..columnCount - 1 as cell >
        ...
        <#if photo_list[row * columnCount + cell]??>                     
            ...
            <#else>
            <a href='${SiteUrl}${photo.loginName}/py/user_photo_show.py?photoId=${photo.photoId}'>${photo.title!?html}</a>
            </#if>
        <#else>
            &nbsp;
        </#if>
