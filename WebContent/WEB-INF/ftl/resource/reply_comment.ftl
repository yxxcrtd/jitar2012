...
<script type="text/javascript" src="${ContextPath}manage/ueditor/lang/zh-cn/zh-cn.js"></script>
  ...
  <script>
        function submit_reply() {
          $("commentReply").value = editor.getContent();
      ...
      <td colspan='2'>
        <br />
	      ...
	      <br />
                        ...
                        <script id="commentReply" name="commentReply" type="text/plain" style="width:840px;height:200px;">
                        </script>                          
                        <script type="text/javascript">
                            var editor = UE.getEditor('commentReply');
                        </script>
