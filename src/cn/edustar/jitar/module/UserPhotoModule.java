...
public class UserPhotoModule extends AbstractModuleWithTP{
	
	public UserPhotoModule() 
	{
		super("user_photo", "我的相册");
	}
	...
	public void handleRequest(ModuleRequest request, ModuleResponse response)throws IOException {
		...
		String template_name = "/WEB-INF/user/default/user_photo.ftl";
