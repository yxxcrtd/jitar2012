...
<input type="button" value="加载默认模板" onclick="GetTemplate('${moduleType!?js_string}&type=index',${channel.channelId})" />
</td>
</tr>
</table>
<#else>
<table style="width:100%">
<tr>
<td style="width:60px;">模块名称：</td><td><input name="moduleDisplayName" value="学科导航" />（模块名称是唯一标识，不能与其它模块名称重复。若修改模块名称，请同时修改频道模板中使用的相应名称。）</td>
</tr>
<tr style="vertical-align:top">
