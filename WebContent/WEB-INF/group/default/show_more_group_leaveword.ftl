...
<div id='placerholder1' title='${grpName}留言' style='display:none;padding:1px;'>
...
<ul class='listul'>
    <table border='0' width='100%' cellspacing='1'>
     ...
     <tbody>
 <#list leaveword_list as leave>
  <#assign u = Util.userById(leave.userId) >
  <tr>
    <td>${leave.title!?html}</td>
    <td>${leave.content!?html}</td>
    <td>${leave.createDate?string('yy-MM-dd')}</td>
    <td>${u.nickName!?html}</td>
  <tr>  
 </#list>
 </table>
</ul>
