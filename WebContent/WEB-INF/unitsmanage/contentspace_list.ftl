...
<td><a href='content_space_edit.py?unitId=${unit.unitId}&contentSpaceId=${category.extendedObject.contentSpaceId}'>修改</a></td>
<#--<td><a href='content_space_article_edit.py?unitId=${unit.unitId}&contentSpaceId=${category.extendedObject.contentSpaceId}'>发布文章</a></td>-->
</tr>
</#list>
</table>
<div style='padding:4px 0'>
<input type='button' value='添加分类' class='button' onclick="document.location.href='content_space_edit.py?unitId=${unit.unitId}&contentSpaceId=0';" />
