...
class show_preparecourse_stage_topic(PrepareCoursePageService):
    def __init__(self):
    ...
    def execute(self):
        ...
        if currentStage == None:
            currentStage = self.pc_svc.getCurrentPrepareCourseStage(prepareCourse.prepareCourseId)
        ...
        return "/WEB-INF/ftl/course/show_preparecourse_stage_topic.ftl"