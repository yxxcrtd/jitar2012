...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <title>全部文章列表 - <#include ('webtitle.ftl') ></title>
...
<div class='head_nav'><#include ('site_subject_category_user_navbar.ftl') >${list_type!'所有文章'}</div>
  ...
  <#if article_list??>
    ...
    <#list article_list as article>
      ...
      <tr>
 		 <td class='list_title'><a href='${u.loginName}/article/${article.articleId}.html' target='_blank'>${article.title!?html}</a></td>
