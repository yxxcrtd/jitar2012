...
<td><a href='site_nav_add.py?unitId=${unit.unitId}&siteNavId=${nav.siteNavId}'>修改</a></td>
</tr>
</#list>
</table>
...
<input type='button' value='添加导航' class='button' onclick='window.location.href="site_nav_add.py?unitId=${unit.unitId}"' />
</div>
</form>
</body>
</html>