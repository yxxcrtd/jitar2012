	...
	<div class='orange_border'>
	  <div class='tree'>
	    <script type="text/javascript">
	        d = new dTree("d");
	        d.add(0,-1,"<b>本站资源</b>","py/resource.py?id=${subject.subjectId}&amp;subjectId=${subject.metaSubject.msubjId}&amp;gradeId=${grade.gradeId}&amp;target=child");
	        ${outHtml}
	        document.write(d);
	        d.openAll();
	  </script>
		  ...
		  <div class='tab_content' style='padding:10px;'>
		    ...
		    <!-- 资源下载排行 -->
		      ...
		      <#list download_resource_list as r>
		        ...
		        <td class="rank_right">
		        <a title='${r.title!?html}' href='${SiteUrl}showResource.action?resourceId=${r.resourceId}'>${Util.getCountedWords(r.title!?html,12)}</a>
		        </td>
...
<td style='padding-left:10px;'>
    ...
    <div class='orange_border'>
    	<div id="article_" class='tab2' style='font-weight:bold;'>		
			...
			<div class="${(type == 'rcmd')?string('cur', '') }" style='border-left:0'><a href='resource.py?type=rcmd&amp;subjectId=${subject.metaSubject.msubjId}&gradeId=${grade.gradeId!}&categoryId=${categoryId!}'>网编推荐</a></div>
      		<div class="${(type == 'new')?string('cur', '') }"><a href='resource.py?type=new&amp;subjectId=${subject.metaSubject.msubjId}&gradeId=${grade.gradeId!}&categoryId=${categoryId!}'>最新发布</a></div>
      		<div class="${(type == 'hot')?string('cur', '') }"><a href='resource.py?type=hot&amp;subjectId=${subject.metaSubject.msubjId}&gradeId=${grade.gradeId!}&categoryId=${categoryId!}'>最高人气</a></div>
      		<div class="${(type == 'cmt')?string('cur', '') }"><a href='resource.py?type=cmt&amp;subjectId=${subject.metaSubject.msubjId}&gradeId=${grade.gradeId!}&categoryId=${categoryId!}'>评论最多</a></div>
 		</div>
	    ...
	    <div id="jitar_res_0"  style="display: block;">		    
	    	...
	    	<thead>
		  	...
		  	<!-- 资源列表 -->
			    ...
			    <tr>
				  	<td style='padding-left:10px;width:100%'><a href='showResource.action?resourceId=${r.resourceId}'><img src='${Util.iconImage(r.href!)}' border='0' align='absmiddle' /> ${Util.getCountedWords(r.title!?html,18)}</a></td>
