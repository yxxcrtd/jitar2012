...
<table style="width:100%">
<tr>
<td style="width:60px;">模块名称：</td><td><input name="moduleDisplayName" value="文章列表" />（模块名称是唯一标识，不能与其它模块名称重复。若修改模块名称，请同时修改频道模板中使用的相应名称。）</td>
</tr>
<tr>
<td>显示条数：</td><td><input name="showCount" value="10" /></td>
</tr>
<tr style="vertical-align:top">
