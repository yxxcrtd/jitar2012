 ...
 */
 (function() {	
  ...
  var m = App._module_infos.user_photo2; 
  // 如果已经加载过了，则不要重复加载
  if (m.loaded) return;
  ...
  function _load_profile(/*widget*/w) {
    ...
    var url = CommonUtil.getCurrentRootUrl() + 'js/jitar/module/user_photo.py?type=2&userId=' + user.id + '&count=' + count + '&tmp=' + (new Date()).getTime();
  ...
  App.onModuleLoaded('user_photo2');
