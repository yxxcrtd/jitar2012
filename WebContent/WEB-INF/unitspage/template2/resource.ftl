<div class='tab_outer' style='min-height:226px;'>
  ...
  <div id="tres_0" class="tres" class="tres" style="display: block;">
  <!-- 最新资源 -->
  <@res_item new_resource_list />  
  </div>
  
  <div id="tres_1" class="tres" class="tres" style="display: none;">
  <!-- 热门资源 -->
  <@res_item hot_resource_list />
  </div>
  
  <div id="tres_2" class="tres" class="tres" style="display: none;">
  <!-- 推荐资源 -->
