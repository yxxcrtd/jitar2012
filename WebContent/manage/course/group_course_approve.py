...
class group_course_approve(SubjectMixiner,BaseAction):
    def __init__(self):
    ...
    def execute(self):        
        ...
        self.pcstatus = self.params.getIntParam("status")
        if self.pcstatus == None:
            actionErrors = [u"无效的操作。"]
            request.setAttribute("actionErrors",actionErrors)
            return self.ERROR
        ...
        self.prepareCourse.setStatus(self.pcstatus)   
