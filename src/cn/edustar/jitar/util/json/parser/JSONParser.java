 ...
 */
package cn.edustar.jitar.util.json.parser;

import java.io.Reader;
import java.util.Stack;

import cn.edustar.jitar.util.json.JSONArray;
import cn.edustar.jitar.util.json.JSONObject;
...
public class JSONParser {
	...
	private int peekStatus(@SuppressWarnings("rawtypes") Stack statusStack){
