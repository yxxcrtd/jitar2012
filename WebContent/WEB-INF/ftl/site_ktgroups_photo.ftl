...
<div class='containter'>
 <div class='head_nav'><#include ('site_subject_category_user_navbar.ftl') > <a href='ktgroups.action'>课题组</a> > 课题成果[图片] </div> 
  <div>
    <#if photo_list??>
    <table class="lastlist" cellspacing="1">
     <tr>
     <th><nobr>图片名称</nobr></th>
    ...
    <td style="text-align: center;"><nobr>${photo.groupTitle}</nobr></td>
