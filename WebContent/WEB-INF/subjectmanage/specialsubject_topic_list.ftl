...
<a href='specialsubject_topic_list.py?id=${subject.subjectId}&specialSubjectId=${ss.specialSubjectId}'>讨论</a> | 
<a href='${SiteUrl}mod/vote/manage_list.action?guid=${subject.objectGuid}&type=specialsubject' target='_blank'>投票</a> | 
