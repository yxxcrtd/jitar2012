...
<head>
  <meta charset="utf-8">
  <title><#include '/WEB-INF/ftl2/common/site_title.ftl' /> - 用户信息变更</title>
...
<div class="secMain mt25 clearfix">
    <div class="moreList border">
      <h3 class="h3Head textIn"><span class="moreHead" style="color:red">你的数据属于导入的，请完善以下用户信息</span></h3>
...
<tr>
  ...
  <td>
      <input type="text" name="loginName" value="" maxlength="16" />
...
<tr>
  <td></td>
  <td>
  <a class="publishBtn" style="float:left" href="javascript:void(0);" onclick="validateInputData();return false;">修改</a>
...
function validateInputData() {
    ...
    var request = $.ajax({
        type: "post",
        url: "initUserAction.action?t" + (new Date()).getTime(),
        cache: false,
        data: json,
        dataType: "json"
    });
