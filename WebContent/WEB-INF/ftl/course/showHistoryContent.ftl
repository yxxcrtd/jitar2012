...
<div class="box">
  <div class="box_head">
    <div class="box_head_left">&nbsp;<img src="../../${ContextPath}css/index/j.gif">&nbsp;查看共案
    （<a href='${SiteUrl}go.action?loginName=${u.loginName}'>${u.trueName?html}</a> 于 ${prepareCourseEdit.editDate} 编写）
    </div>
  </div>
