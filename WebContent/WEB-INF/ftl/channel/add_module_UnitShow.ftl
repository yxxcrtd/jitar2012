...
<td>
    <#list unitTypeList as ut >
       <#if module.unitType==ut>
        <input type="radio" name="typeName" value="${ut}" checked>${ut}
       <#else> 
        <input type="radio" name="typeName" value="${ut}">${ut}
      </#if>
    </#list> 
...
<table>
<tr>
<td style="width:60px;">模块名称：</td><td><input name="moduleDisplayName" value="机构展示模块" />（模块名称是唯一标识，不能与其它模块名称重复。若修改模块名称，请同时修改频道模板中使用的相应名称。）</td>
</tr>
<tr>
<td>机构属性：</td>
<td>
