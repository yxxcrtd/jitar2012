...
class group_article_category(ActionExecutor, CategoryMixiner):
    def __init__(self):
    ...
    def dispatcher(self, cmd):
        ...
        # 计算协作组文章分类 itemType.
        self.itemType = self.toGroupArticleCategoryItemType(self.group)
    ...
    def list(self):
        ...
        return "/WEB-INF/ftl/group/group_cate_article_list.ftl"
    ...
    def add(self):
        ...
        return "/WEB-INF/ftl/group/group_cate_article_add.ftl"
    ...
    def edit(self):
        ...
        return "/WEB-INF/ftl/group/group_cate_add.ftl"
    ...
    def updateGroupCategoryId(self, category):
        cmd = Command(""" UPDATE GroupArticle SET groupCateId = NULL
