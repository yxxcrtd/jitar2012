...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <title>全部精华文章列表 - <#include ('webtitle.ftl') ></title>
 ...
 <div class='head_nav'><#include ('site_subject_category_user_navbar.ftl') >所有精华文章</div>
 
  <div>	
  <#if best_article_list??>
    ...
    <#list best_article_list as article>
      ...
      <tr>
 		 <td class='list_title'><a href='${SiteUrl}showArticle.action?articleId=${article.articleId}' target='_blank'>${article.title!?html}</a></td>
