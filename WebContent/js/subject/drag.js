...
{	
	  ...
	  var url = SubjectUrl + "manage/subjectWebpartAction.action?cmd=move&widgetId="+ currentWidgitId + "&col=" + col + "&wbi=" + nextWidgitId ;
	  logger.log('url = ' + url);
...
Drag.chg = function(elm){ 
  ...
  {
  	w_id = w_id.split("_")[1]
  	var url = SubjectUrl + "manage/subjectWebpartAction.action?cmd=delete&widgetId="+ w_id ;
	  logger.log('url = ' + url);
	  new Ajax.Request(url, { 
	      method: 'get',
