		...
		<tr>
			<td class="list_title">
				<table width="100%">
					<tr>
						<td width="64">
							<img src="${Util.url(user.userIcon!"images/default.gif")}" onerror="this.src='${SiteUrl}images/default.gif'" width='64' height='64' border='0' />
						</td>
						<td align='left' valign='top'>
							...
							<div style="line-height: 16px;">标签: 
								<#list Util.tagToList(user.userTags!) as t> 
									<a href='${SiteUrl}showTag.py?tagName=${t?url("UTF-8")}'>${t}</a><#if t_has_next>,</#if>
								</#list>
							</div>
