...
(function () {
    ...
    var ueditorUploadPath = window.UEDITOR_UPLOAD_URL;
    var editerUserName = window.UEDITOR_USERLOGINNAME;
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,userName:editerUserName					//用户登录名 
        //图片上传配置区
        ,imageUrl:URL+"jsp/imageUp.jsp"             //图片上传提交地址
        ,imagePath:ueditorUploadPath 
        ...
        ,scrawlPath:ueditorUploadPath                     //图片修正地址，同imagePath
        //,scrawlPath:URL+"jsp/"                     //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:ueditorUploadPath           //附件修正地址，同imagePath
        ...
        ,catcherPath:ueditorUploadPath                   //图片修正地址，同imagePath
        ...
        ,imageManagerPath:ueditorUploadPath                                     //图片修正地址，同imagePath
        ...
        ,snapscreenPath: ueditorUploadPath
        ...
        ,wordImagePath:ueditorUploadPath                      
        ...
        ,videoPath:ueditorUploadPath                   //附件修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'scrawl', 'attachment', 'map', 'gmap', 'insertframe','insertcode', 'pagebreak', 'background', '|',
