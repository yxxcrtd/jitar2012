...
function Lunar(objDate) {
 ...
 function YYMMDD(){
    ...
    if (now.getDay() == 0) cl = '<font color="#011CB1" STYLE="font-size:9pt;">';
    if (now.getDay() == 6) cl = '<font color="#011CB1" STYLE="font-size:9pt;">';
    return(cl+SY+'年'+(SM+1)+'月'+SD+'日</font>');
 }
 function weekday(){
    var day = new Array("星期日","星期一","星期二","星期三","星期四","星期五","星期六");
    var cl = '<font color="#011CB1" STYLE="font-size:9pt;">';
    if (now.getDay() == 0) cl = '<font color="#011CB1" STYLE="font-size:9pt;">';
    if (now.getDay() == 6) cl = '<font color="#011CB1" STYLE="font-size:9pt;">';
...
"1006 老人节","1024 联合国日","1112 孙中山诞辰","1220 澳门回归纪念","1225 圣诞节","1226 毛泽东诞辰")
  ...
  if(solarTerms == '' && solarFestival == '' && lunarFestival == '')
    ...
    festival = ' <FONT COLOR="#011CB1" STYLE="font-size:9pt;">'+solarTerms + ' ' + solarFestival + ' ' + lunarFestival+'</FONT>';

  return(festival+'</font>');
 }
