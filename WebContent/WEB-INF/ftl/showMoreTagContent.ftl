...
<table class='border_table' cellspacing='1' cellpadding='0'>
 <tr>
 <td class='border_table_header' style='border:0'>使用<span class='redtext'>${tag.tagName}</span>的所有工作室</td>
 </tr>
 <tr>
 ...
 <table class='border_table' cellspacing='1' cellpadding='0'>
 <tr>
 <td class='border_table_header' style='border:0'>使用<span class='redtext'>${tag.tagName}</span>的所有协作组</td>
 </tr>
 <tr>
 <td style='padding:10px 0 10px 28px;'>
    <ul>
...
<#if tag_article_list??>
 <table class='border_table' cellspacing='1' cellpadding='0'>
 <tr>
 <td class='border_table_header' style='border:0'>使用<span class='redtext'>${tag.tagName}</span>的所有文章</td>
 </tr>
 <tr>
 <td style='padding:10px 0 10px 28px;'>			 
...
<#if tag_resource_list??>
 <table class='border_table' cellspacing='1' cellpadding='0'>
 <tr>
 <td class='border_table_header' style='border:0'>使用<span class='redtext'>${tag.tagName}</span>的所有资源</td>
 </tr>
 <tr>
 <td style='padding:10px 0 10px 28px;'>			 
...
<#if tag_photo_list??>
 <table class='border_table' cellspacing='1' cellpadding='0'>
 <tr>
 <td class='border_table_header' style='border:0'>使用<span class='redtext'>${tag.tagName}</span>的所有图片</td>
 </tr>
 <tr>
 <td style='padding:10px 0 10px 28px;'>	
    <ul>
...
<#if tag_preparecourse_list??>
 <table class='border_table' cellspacing='1' cellpadding='0'>
 <tr>
 <td class='border_table_header' style='border:0'>使用<span class='redtext'>${tag.tagName}</span>的所有备课</td>
 </tr>
 <tr>
 <td style='padding:10px 0 10px 28px;'>
    <ul>
...
<div style='text-align:center;'><#include 'inc/pager.ftl'></div>
