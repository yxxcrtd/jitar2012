...
function GetChatmsg() {
	...
	var url = "groupTalkRoom.action?cmd=privateinfo&roomId=${chatroom.roomId}&groupId=${groupId}&from=1&lastDate="+lastDate+ "&d=" +(Date.parse(new Date()));
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="45%" style="table-layout:fixed">
	<tr>
		<td valign="top">
