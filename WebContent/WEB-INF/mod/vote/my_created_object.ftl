...
<div class='tab_outer'>
  <div id="article_" class='tab2'>
    <div class="cur"><a href='my_created_object.py'>我发起的投票</a></div> 
    <div><a href='my_joined_object.py'>我参与的投票</a></div> 
  </div>
...
<tr>
<td><input type='checkbox' name='guid' value='${vote.voteId}' /></td>
