...
<table border="0" cellspacing='0' cellpadding='0' class="datalist">
<thead>
<tr>
<th style="text-align:center">标题</th>
<th nowrap='nowrap'>作者</th>
<th nowrap='nowrap' style="background:url()">发表日期</th>
</tr>
</thead>
<#if article_list??>
<tbody>
<#list article_list! as a>
 <tr style="vertical-align:top">
  <td style="padding-left:10px;">
  	<span><#if a.typeState == false>[原创]<#else>[转载]</#if></span>
    <a href='${SiteUrl}showArticle.action?articleId=${a.articleId}'>${Util.getCountedWords(a.title!?html,42)}</a>
  </td>
  <td nowrap='nowrap' style='width:100px;text-align:center;'><a href='${SiteUrl}go.action?loginName=${a.loginName}' target='_blank'>${a.userTrueName!?html}</a></td>
  <td nowrap='nowrap' style='width:100px;text-align:center;'>${a.createDate?string('yyyy-MM-dd') }</td>
  </tr>
 </#list>
</tbody>
</#if>
