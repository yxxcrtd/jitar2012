...
<td colspan="2">
            <script id="columnContent" name="columnContent" type="text/plain" style="width:980px;height:400px;">
            <#if jitarColumnNews??>${jitarColumnNews.content!}</#if>
            </script>
            <script type="text/javascript">
                var editor = UE.getEditor('columnContent');
            </script> 
