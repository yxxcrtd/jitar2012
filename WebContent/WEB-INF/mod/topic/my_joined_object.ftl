...
<div class='tab_outer'>
  <div id="article_" class='tab2'>
    <div><a href='my_created_object.py'>我发起的讨论</a></div> 
    <div class="cur"><a href='my_joined_object.py'>我参与的讨论</a></div> 
  </div>
  <div style="padding:10px">

<#if topic_reply_list?? >
<form method="post" action='my_joined_object.py'>
...
<tr>
<td><input type='checkbox' name='guid' value='${tr.plugInTopicReplyId}' /></td>
