...
<tr>
<th style='width:66px;'>调查名称：</th><td><input name='vote_title' style='width:500px' value='${vote.title?html}' /></td>
</tr>
<tr>
<th style='vertical-align:top'>调查描述：</th><td><textarea name='vote_desc' style='width:500px;height:40px'>${vote.description?html}</textarea></td>
</tr>
<tr>
...
<input name='vote_q_${q.question.voteQuestionId}' value='${q.question.title?html}' style='width:500px' /></td>
</tr>
<tr>
<td>问题类型：</td><td>
...
<#list q.answer as a>
	...
	<div><textarea name='q_a_${a.voteQuestionAnswerId}' style='width:500px;height:40px'>${a.answerContent?html}</textarea></div>
</#list>
	<div><textarea name='new_answer_${q.question.voteQuestionId}' style='width:500px;height:40px' onclick='addQuestionItem(event,${q.question.voteQuestionId})' onkeydown='addQuestionItem(event,${q.question.voteQuestionId})'></textarea></div>
</td>
</tr>
</#if>
</#list>
