<div class='panel'>
  <div class='panel_head'>
    <div class='panel_head_right'><a href='${SubjectRootUrl}py/blogList.py?type=famous&unitId=${unitId!}&title=${webpart.displayName!?url}'>更多…</a></div>
  ...
  <div class='panel_content'>    
    ...
    <#list 0..rowCount -1 as row>
        ...
        <td style='text-align:center;width:33%;padding-bottom:4px;'>
            <#if famous_user_list[row * columnCount + cell]?? >
            <#assign u = famous_user_list[row * columnCount + cell] >
