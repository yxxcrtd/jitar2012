...
<#if photoStaple??>
<script>document.write('<div id=\'placerholder1\' title=\''+unescape("${title!?html}")+' 分类下的照片\' style=\'display:none\'>');</script>
<#else>
<div id='placerholder1' title='全部照片' style='display:none'>
</#if>
