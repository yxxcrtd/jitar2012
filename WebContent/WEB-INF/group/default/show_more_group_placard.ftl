...
<div id='placerholder1' title='${grpName}公告' style='display:none;padding:1px;'>

<#if placard_list??>
<ul class='listul'>
 <#list placard_list as placard>
  <#assign u = Util.userById(placard.userId) >
  <li>[${placard.createDate?string('yy-MM-dd')}] <a href='${SiteUrl}showPlacard.action?placardId=${placard.id!}' target='_blank' 
    title='发布时间：${placard.createDate!}&#13;发布人:${u.nickName!?html}'>${placard.title!?html}</a>
  </li>
 </#list>
</ul>
 </#if>    
