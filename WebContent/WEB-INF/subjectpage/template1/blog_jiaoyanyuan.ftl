<div class='panel'>
  <div class='panel_head'>
    <div class='panel_head_right'><a href='${SubjectRootUrl}py/blogList.py?type=comiss&subjectId=${subject.metaSubject.msubjId}&gradeId=${gradeId!}&unitId=${unitId!}' class='blog_more'>更多…</a></div>
    <div class='panel_head_left titlecolor'>教研员工作室</div>
  </div>
