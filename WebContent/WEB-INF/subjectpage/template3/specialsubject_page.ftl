...
<div class='panel'>
  ...
  <div class='panel_content'>
	...
	<#if specialSubject?? &&  !specialSubject.expired>
   		<div style='font-weight:bold;text-align:right;padding:2px;'><a title='Falsh 显示只支持jpg（小写）格式的' href='${SiteUrl}manage/photo.action?cmd=upload&amp;specialSubjectId=${specialSubject.specialSubjectId!?default('0')}' target='_blank'>上传专题图片</a></div>
   	</#if>
...
<div class='panel'>
	  ...
	  <div class='panel_content'>
		...
		<#if specialSubject?? &&  !specialSubject.expired>
		<div style='font-weight:bold;text-align:right;padding:2px;'><a href='${SiteUrl}manage/article.action?cmd=input&amp;specialSubjectId=${specialSubject.specialSubjectId!?default('0')}' target='_blank'>发布专题文章</a></div>
		</#if>
	  </div>
	</div>
	<div style='height:8px;font-size:0;'></div>
	...
	<div class='panel'>
	  ...
	  <div class='panel_content'>
		...
		<#else>
			请<a href='${SiteUrl}login.jsp' style='font-weight:bold;'>登录</a>后提交候选专题。
		</#if>
		</td>
		</tr>
		</table>
