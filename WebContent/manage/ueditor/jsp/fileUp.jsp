...
//  }else{
//	response.getWriter().print("没有得到登录用户信息"); 
//  } 
%>
  ...
  <%
    ...
    Uploader up = new Uploader(request,loginName);
    String[] fileType = {".rar" , ".doc" , ".docx" , ".zip" , ".pdf" , ".txt" , ".swf", ".wmv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4",".ppt",".pptx",".jpg",".jpeg",".gif",".xls",".xlsx"};  //允许的文件类型
