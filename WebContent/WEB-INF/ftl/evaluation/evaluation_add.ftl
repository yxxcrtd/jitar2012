...
<div>
    ...
    <div>
            请选择授课人:<input name="teacherName" id="teacherName"  style="width:140px;" readonly class="txt" onChange="userchanged()"/><font style="color:red">*</font>&nbsp;&nbsp;<input type="button" name="selectuser" value="点此选择授课人..." onClick="selectUsers();"/>
    ...
    <hr/>  
       点击这里新增评课 <a href="#" id="AHref" onClick="showevaluationContent();"><<<</a>
       <div style='height:8px;font-size:0;'></div>
        ...
        <td>
          <#if template_list??>
              <#list template_list as t>            
                <input type="checkbox" name="template" value="${t.evaluationTemplateId}"/>${t.evaluationTemplateName!?html}</br>
              </#list>
           </#if>     
        </td>
    </tr>    
