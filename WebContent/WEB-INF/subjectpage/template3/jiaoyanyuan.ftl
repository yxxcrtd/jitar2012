<div class='panel'>
  <div class='panel_head'>
    <div class='panel_head_right'><a href='${SubjectRootUrl}py/blogList.py?type=comiss&unitId=${unitId!}&title=${webpart.displayName!?url}'>更多…</a></div>
  ...
  <div class='panel_content'>    
    ...
    <#list 0..rowCount -1 as row>
        ...
        <td style='text-align:center;width:33%;padding-bottom:4px;'>
            <#if jiaoyanyuan[row * columnCount + cell]?? >
            <#assign u = jiaoyanyuan[row * columnCount + cell] >
