...
<thead><tr><td class="widgetHead h_lt"></td><td class="widgetHead h_mt"><div class="widgetHeader"><div class="ico"><img class="mod_icon" src="${SiteUrl}images/pixel.gif" height="16" width="16" border="0"></div><div id="webpart_4_h" class="title"><script>document.write(unescape("${k!}"));</script></div></div></td><td class="widgetHead h_rt"></td></tr></thead><tbody><tr class="widgetEditor" style="display: none;"><td class="widgetEdit e_lt"></td><td class="widgetEdit e_mt"></td><td class="widgetEdit e_rt"></td></tr><tr><td class="widgetContent c_lt"></td><td class="widgetContent c_mt">
<#if k?? && k != "">
...
{
     var url = "${UserSiteUrl}py/user_article_search_list.py?k=${k?url}&page=";
