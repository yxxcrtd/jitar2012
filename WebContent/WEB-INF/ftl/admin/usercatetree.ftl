...
<th style='width:20px'><input type='checkbox' onclick='CommonUtil.SelectAll(this,"guid")'/></th>
<th>分类名称</th>
<th style="width:200px;">创建日期</th>
<th style="width:100px;">文章数</th>
<th style="width:200px;">操作</th>
<th style="width:120px;">发布文章</th>
</tr>
</thead>
...
<td><a href='content_space_edit.py?id=${category.extendedObject.contentSpaceId}'>修改</a></td>
<td><a href='content_space_article_edit.py?id=${category.extendedObject.contentSpaceId}'>发布文章</a></td>
<#--
<td><a href='content_space_article_list.py?id=${category.extendedObject.contentSpaceId}'>管理文章</a></td>
-->
</tr>
</#list>
</table>
<div style='padding:4px 0'>
<input type='button' value='添加分类' class='button' onclick="document.location.href='content_space_edit.py?id=0';" />
