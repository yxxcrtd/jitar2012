...
class admin_mashup_article_list(BaseAdminAction, ActionResult):
    ...
    def execute(self):
        ...
        self.show_list()        
        return "/WEB-INF/mashup/admin_mashup_article_list.ftl"
    ...
    def show_list(self):
        qry = MashupContentQuery("""
                ...
                mc.title,mc.unitName,mc.unitTitle,mc.author,mc.orginId,mc.href,mc.pushDate
                """)
