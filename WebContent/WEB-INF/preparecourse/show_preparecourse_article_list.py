...
class show_preparecourse_article_list(PrepareCoursePageService):
    def __init__(self):
    ...
    def execute(self): 
        ...
        pager.itemName = u"文章"
        pager.itemUnit = u"篇"       
        qry = PrepareArticleQuery("pca.userId, pca.articleId, pca.title,pca.createDate,pca.typeState,pca.title")
        qry.prepareCourseStageId = currentStage.prepareCourseStageId
        pager.totalRows = qry.count()
        artile_list = qry.query_map(pager)    
        ...
        return "/WEB-INF/ftl/course/show_preparecourse_stage_article_list.ftl"