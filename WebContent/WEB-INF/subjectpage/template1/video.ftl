  ...
  <div class='panel_content'>
	...
	<#list new_video_list as p>
		<td style='text-align:center;width:25%;padding-bottom:4px;'>	            
          ...
          <div style='text-align:center;overflow:hidden;'><a onmouseover='this.title=this.innerHTML' href='${SiteUrl}manage/video.action?cmd=show&videoId=${p.videoId}'><#if (p.title?length lt 18)>${p.title!?html}<#else>${p.title[0..17]!?html}</#if></a></div>	            
          </td>
      </#list>
     </tr>
     </table>
