...
function TimeoutChangeToTOC()
{
	...
	if (window.TabFrame().document.images['TocTab'] != null) {
		window.TabFrame().document.images['TocTab'].src='../resources/bssctab1.gif';
	}
	if (window.TabFrame().document.images['IndexTab'] != null) {
		window.TabFrame().document.images['IndexTab'].src='../resources/bssctab4.gif';
	}
	if (window.TabFrame().document.images['FtsTab'] != null) {
		window.TabFrame().document.images['FtsTab'].src='../resources/bssctab6.gif';
	}
...
function SelectTOC()
{
	...
	if (TabFrame().document.images['TocTab'] != null) {
		TabFrame().document.images['TocTab'].src='../resources/bssctab1.gif';
	}
	if (TabFrame().document.images['IndexTab'] != null) {
		TabFrame().document.images['IndexTab'].src='../resources/bssctab4.gif';
	}
	if (TabFrame().document.images['FtsTab'] != null) {
		TabFrame().document.images['FtsTab'].src='../resources/bssctab6.gif';
	}
...
function TimeoutChangeToIndex()
{
	...
	if (window.TabFrame().document.images['TocTab'] != null) {
		window.TabFrame().document.images['TocTab'].src='../resources/bssctab2.gif';
	}
	if (window.TabFrame().document.images['IndexTab'] != null) {
		window.TabFrame().document.images['IndexTab'].src='../resources/bssctab3.gif';
	}
	if (window.TabFrame().document.images['FtsTab'] != null) {
		window.TabFrame().document.images['FtsTab'].src='../resources/bssctab6.gif';
	}
...
function SelectIndex()
{
	...
	if (TabFrame().document.images['TocTab'] != null) {
		TabFrame().document.images['TocTab'].src='../resources/bssctab2.gif';
	}
	if (TabFrame().document.images['IndexTab'] != null) {
		TabFrame().document.images['IndexTab'].src='../resources/bssctab3.gif';
	}
	if (TabFrame().document.images['FtsTab'] != null) {
		TabFrame().document.images['FtsTab'].src='../resources/bssctab6.gif';
	}
...
function SelectFTS()
{
	...
	if (TabFrame().document.images['FtsTab'] != null) {
		TabFrame().document.images['FtsTab'].src='../resources/bssctab5.gif';
	}
	NavFrame().ShowDiv('TocNav', false);
	NavFrame().ShowDiv('IndexNav', false);
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////
var imgBookClose ="../resources/bssctoc1.gif";
var imgBookOpen  ="../resources/bssctoc2.gif";
