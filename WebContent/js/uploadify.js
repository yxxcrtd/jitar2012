			...
			uploadify : function(options) {
				jQuery(this).each(function() {
					...
					if (settings.onInit() !== false) {
						...
						swfobject.embedSWF(settings.uploader, settings.id + 'Uploader', settings.width, settings.height, '11.8.800', settings.expressInstall, data, { 'quality' : 'high', 'wmode' : settings.wmode, 'allowScriptAccess' : settings.scriptAccess }, {}, function(event) {
