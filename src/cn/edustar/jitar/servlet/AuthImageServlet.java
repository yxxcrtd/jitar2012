 ...
 *
 * @author Yang XinXin
 * @version 1.0.0 Mar 20, 2008 4:37:11 PM
 */
public class AuthImageServlet extends HttpServlet {
	private static final long serialVersionUID = -6735877702941513810L;
	...
	private String getRandomChar() {
		...
		// 根据 rand 的值来决定是生成一个大写字母、小写字母或数字
		switch (rand) {
