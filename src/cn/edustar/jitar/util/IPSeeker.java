...
public class IPSeeker {
	 ...
	 */
	private IPSeeker() {
		IP_FILE = cn.edustar.jitar.JitarRequestContext.getRequestContext().getServletContext().getRealPath("/");
		IP_FILE += "images" + File.separator + "qqwry.dat";
		...
		try {
			...
			System.out.println(IP_FILE + "IP地址信息文件没有找到，IP显示功能将无法使用");
			ipFile = null;
	...
	public String getAddress(String ip) {
		...
		if(area.equals("对方和您在同一内部网")) area = "内部网";
